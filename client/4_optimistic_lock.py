...
dist_map = client.get_map("counter-optimistic").blocking()
dist_map.put_if_absent("key", 0)

print(f"[Client {client_id}] Starting 10K increments with optimistic locking...")
...
for i in range(10_000):
    ...
    try:
        ...
        # Progress indicator
        if i > 0 and i == 100:
            print(f"[Client {client_id}] Reached {i}/10000 increments...")
    finally:
        dist_map.unlock("key")
